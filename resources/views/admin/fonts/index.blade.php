                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" style="text-align: center">
                                ...
                                <th class="info">状态</th>
                                <th class="info">时间</th>
                                @can('changeStatus',\App\Models\Font::class)
                                ...
                                @foreach($font as $val)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endcan
                                            @can('delete',\App\Models\Font::class)
                            ...
                            {!! PaginateRoute::renderPageList($font,false,'pagination',true) !!}
                        </div>

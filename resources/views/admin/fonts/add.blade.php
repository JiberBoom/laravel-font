        ...
        <div class="row">
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-heading">增加字体</div>
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{url('/admin/fonts/store')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('font_url') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="file" class="form-control" name="font_url" required>
                            ...
                            <div class="form-group{{ $errors->has('download') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="download" type="text" class="form-control" name="download" value="{{ old('download') }}" required >
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="price" placeholder="单位：元" type="text" class="form-control" name="price" value="{{ old('price') }}" required >
                                    @if ($errors->has('price'))
                                        <span class="help-block">

            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="{{url('/permissions/'.$infos->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="font_url" class="col-md-4 control-label">权限名</label>
                            ...
                            <div class="form-group{{ $errors->has('guard_name') ? ' has-error' : '' }}">
                                <label for="download" class="col-md-4 control-label">权限Guard</label>
